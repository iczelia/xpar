...
void blake2b_compress_sse41(blake2b_state *restrict s,
  ...
  __m128i row4l =
      _mm_xor_si128(_mm_loadu_si128((const __m128i *)&blake2b_IV[4]),
                    _mm_loadu_si128((const __m128i *)&s->t[0]));
  __m128i row4h =
      _mm_xor_si128(_mm_loadu_si128((const __m128i *)&blake2b_IV[6]),
...
#define G2(b0, b1)                                                             \
  do {                                                                         \
    ...
    {                                                                          \
      ...
      row2l = _mm_xor_si128(_mm_srli_epi64(t, 63), _mm_add_epi64(t, t));       \
    }                                                                          \
    {                                                                          \
      __m128i t = _mm_xor_si128(row2h, row3h);                                 \
      row2h = _mm_xor_si128(_mm_srli_epi64(t, 63), _mm_add_epi64(t, t));       \
    }                                                                          \
  } while (0)
